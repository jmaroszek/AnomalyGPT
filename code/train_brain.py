...
#takes in information from train_brain.sh.
def parser_args():
...
# initalizes distributed training environment for deepseed. No change.
...
#This creates the save and log directories for training. 
